...
export interface AuthServiceInterface {
	...
	generateToken(user: User): Promise<{ token: string; refreshToken: string; expiresAt: string }>
	verifyToken(token: string): Promise<User | null>
	refreshToken(refreshToken: string): Promise<{ token: string; refreshToken: string; expiresAt: string } | null>
