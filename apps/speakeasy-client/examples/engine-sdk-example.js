...
async function main() {
    ...
    const client = new index_1.EngineClient({
        host: ENGINE_HOST,
        port: ENGINE_PORT,
    ...
    try {
        ...
        const simpleResponse = await client.process('text-processing', 'This is a sample text to process', {
            priority: 5,
            timeout: 60
        }, {
        ...
        try {
            ...
            if (error instanceof index_1.EngineClientError) {
...
//# sourceMappingURL=engine-sdk-example.js.map